...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      icons = {
        ...
        -- If you are using a Nerd Font: set icons.keys to an empty table which will
        -- default which-key.nvim define Nerd Font icons, otherwise define a string
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'rust', 'json', 'python' },
